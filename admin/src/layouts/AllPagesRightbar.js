...
export default function Pagesaddtask(props) {
    ...
    //     // Get the selected project ID from the event
    //     const projectId = e?.target?.value;
    //     // Store the selected project ID in the state variable
    //     setselectedProject(projectId);
    //     alert("Selected Project:", projectId); // Add this line for debugging
    // };
                                    ...
                                    <Row>
                                        <Col lg={6}>
                                            <Form.Group className="mb-1" controlId="exampleForm.ControlInput1">
                                                ...
                                                <Form.Select
                                                    // onChange={handleProjectChange}  // <- Remove ()
