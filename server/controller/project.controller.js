...
//       //{ $match: { activeStatus: JSON.parse(active) } },
//       const projects = await projectModel.aggregate([
...
//       const projects = await projectModel.aggregate([
//         { $match: { projectStatus: projectStatus } },
//         {
//           $lookup: {
//             from: "technologies",
//             localField: "technology",
...
//         } else {
//           const projects = await projectModel.aggregate([
//             { $match: { activeStatus: req.query.activeStatus, projectStatus: projectStatus } },
//             {
//               $lookup: {
//                 from: "technologies",
//                 localField: "technology",
...
//         const projects = await projectModel.aggregate([
//           { $match: { activeStatus: active, projectStatus: projectStatus } },
//           {
//             $lookup: {
//               from: "technologies",
//               localField: "technology",
